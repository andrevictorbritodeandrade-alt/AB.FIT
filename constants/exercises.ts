...
export const EXERCISE_DATABASE: Record<string, string[]> = {
  "Peito": [
    ...
    "Supino reto com HBC",
    "Supino aberto no banco inclinado na máquina",
  ...
  "Quadríceps e Adutores": [
    ...
    "Agachamento livre com HBM barra sobre ombros",
    "Agachamento livre",
    "Agachamento no hack machine",
    "Agachamento no aparelho hack machine",
